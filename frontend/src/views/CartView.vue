      ...
      <div class="lg:col-span-2 space-y-4">
        ...
        >
          ...
          <div class="flex-1">
            ...
            <p class="text-gold-700 font-bold text-lg">{{ item.price.toFixed(2) }} €</p>
            ...
            <div class="flex items-center gap-3 mt-4">
              ...
              <input
                ...
                min="1"
                :max="item.stock"
                class="w-16 text-center border border-gray-300 rounded-lg py-1 focus:ring-2 focus:ring-gold-500 focus:border-transparent"
              />
